...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { cpf: @aluno.cpf, email: @aluno.email, habilitado: @aluno.habilitado, lattes: @aluno.lattes, matricula: @aluno.matricula, nome: @aluno.nome }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { cpf: @aluno.cpf, email: @aluno.email, habilitado: @aluno.habilitado, lattes: @aluno.lattes, matricula: @aluno.matricula, nome: @aluno.nome }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
