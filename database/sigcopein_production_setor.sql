...
CREATE TABLE `setor` (
  ...
  KEY `fk_setor_servidor1_idx` (`servidor_id`),
  CONSTRAINT `fk_setor_servidor1` FOREIGN KEY (`servidor_id`) REFERENCES `servidor` (`servidor_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
