...
CREATE TABLE `memorando` (
  ...
  KEY `fk_memorando_projeto1_idx` (`projeto_id`),
  CONSTRAINT `fk_memorando_projeto1` FOREIGN KEY (`projeto_id`) REFERENCES `projeto` (`projeto_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
