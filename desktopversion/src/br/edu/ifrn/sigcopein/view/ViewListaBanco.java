...
import br.edu.ifrn.sigcopein.tabela.TabelaBanco;
 ...
 * @author 1935921
 */
public class ViewListaBanco extends javax.swing.JInternalFrame {

    private List<Banco> lista = null;
    private BancoService service = new BancoService(new SimpleEntityManager());
 private JFrame frame;
   
    /**
     * Creates new form ViewListaBancoes
     */
    public ViewListaBanco(JFrame f) {
        initComponents();
        carregarTabela();
        this.frame = f;
    }
    ...
    private void carregarTabela() {
        ...
        TabelaBanco tb = new TabelaBanco(lista);
        tbBanco.setModel(tb);
    }
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        ViewIncluirEditarBanco view = new ViewIncluirEditarBanco(frame, true, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        if (tbBanco.getSelectedRow() != -1) {
            TabelaBanco tb = (TabelaBanco) tbBanco.getModel();
            Banco s = tb.get(tbBanco.getSelectedRow());
            ViewIncluirEditarBanco view = new ViewIncluirEditarBanco(frame, true, s);
            view.setVisible(true);
        } else {
